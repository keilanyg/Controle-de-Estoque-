...
@has_permission_decorator('cadastrar_vendedor') #Somente quem ja está cadastrado no sistema, tem essa permissão.
...
def vendedores_cadastrados(request):
    vendedores = Users.objects.filter(cargo="V")
    return render(request, 'vendedores_cadastrados.html', {'vendedores': vendedores})
