...
def add_produto(request):
    if request.method == "GET":
        ...
        for f in request.FILES.getlist('imagens'):
            ...
            draw.text((20, 280), f"CONSTRUÇÃO {date.today()}", (255, 255, 255))
            output = BytesIO()
...
def ver_estoque(request):
    ...
    categorias = Categoria.objects.all()
    return render(request, 'ver_estoque.html', {'categorias': categorias, 'produtos': produtos},)


# Filtrar slug por produto
